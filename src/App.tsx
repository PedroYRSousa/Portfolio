  ...
  return (
    <main>
      <div className='profile'>
        <div className='profile-image'>
          <a href={social.profile.link} target='_blank' rel="noreferrer">
            <img className='profile-image-src' src={process.env.PUBLIC_URL + social.profile.image} alt='profile' />
          </a>
        </div>
        <h3>{author}</h3>
      ...
      <div className='social'>
        <a href={social.github.link} target='_blank' rel="noreferrer"><img src={process.env.PUBLIC_URL + social.github.image} alt='github'/></a>
        <a href={social.twitch.link} target='_blank' rel="noreferrer"><img src={process.env.PUBLIC_URL + social.twitch.image} alt='twitch'/></a>
        <a href={social.linkedIn.link} target='_blank' rel="noreferrer"><img src={process.env.PUBLIC_URL + social.linkedIn.image} alt='LinkedIn'/></a>
        <a href={social.email.link} target='_blank' rel="noreferrer"><img src={process.env.PUBLIC_URL + social.email.image} alt='email'/></a>
      </div>
    </main>
  );
}
